...
export function NotificationsPage() {
  ...
  return (
    <div>
      <h2>Notifications</h2>
      <p className="hint">
        Every alert this account has received. Stored server-side, so nothing is lost when a push
        fails to deliver.
      </p>
      ...
      {items && items.length === 0 && (
        <EmptyState
          ...
          subtitle="Requests entering the verification queue and responses to your posts will appear here."
        />
      )}
