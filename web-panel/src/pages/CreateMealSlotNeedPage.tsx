...
// PRD §10.1/§10.2 — post a MEAL_SLOT need. Links the request to **this** institution automatically
// (D-008), same reasoning as blood — a hospital/orphanage posting its own request can
